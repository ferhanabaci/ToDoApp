...
namespace ToDoApp
{
    class Program
    {
        ...
        {
            int choice;
            Console.WriteLine("Lütfen Bir İslem Seciniz:");
            Console.WriteLine("*************************");
            Console.WriteLine("(1)Board Listelemek");
            Console.WriteLine("(2) Board Kart Eklemek");
            Console.WriteLine("(3) Board Kart Silmek");
            ...
            switch (choice)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    Console.WriteLine("Gecersiz secim yaptınız!");
                    break;
            ...
            {
                //index al, kartı al,eskiden sil yeniye ekle 
                string _title, _line = String.Empty;
                Card _card = new Card(null, null, -1, -1);
                int index = -1;
                Console.WriteLine("Öncelikli taşımak istediginiz kartı secmeniz gerekiyor.");
                ...
                {
                    Console.WriteLine("Aradıgınız kriterlere uygun kart board bulanamadı.Lütfen bir secim yapınız.");
                    ...
                    {
                        Console.WriteLine("Gecersiz bir islem sectiniz.İslem Sonlandırılıyor.");
                        HomePage();
